...
export const useVigilanteStore = create<VigilanteState>()(
    (set, get) => ({
            ...
            setupRealtime: () => {
                ...
                // CRÍTICO: Solo eliminar el canal de vigilantes, NO removeAllChannels()
                // que destruiría los canales de programación y puestos causando pérdida de datos.
                    ...
                    .on(
                        ...
                        async (payload) => {
                            ...
                            if (payload.eventType === 'DELETE') {
                                ...
                                // Para INSERT y UPDATE, refrescar con debounce para no saturar
