...
async function main() {
  console.log('--- CLEANING UP ZONA 13 JUNE 2026 DATA ---');

  // Get all puestos in ZONA 13
  ...
  console.log(`Found ${puestos.length} puestos in ZONA 13`);
  ...
  console.log(`Found ${progs.length} programaciones in June 2026 for ZONA 13`);
