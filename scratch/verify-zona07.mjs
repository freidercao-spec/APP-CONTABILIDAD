/**
 * CORAZA CTA — Verificación de Programación JUNIO 2026 (ZONA 07)
 * ================================================================
...
async function main() {
  ...
  console.log(`📄 Puestos en Excel: ${excelData.length - 1} (sin DISPONIBLES)\n`);
  ...
  for (const excelPuesto of excelData) {
    ...
    const ok = (asigCount || 0) >= expectedDias * 0.9;
