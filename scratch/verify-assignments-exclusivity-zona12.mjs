...
async function main() {
  ...
  // Get all programaciones for June 2026 in ZONA 12
  ...
  console.log('=== VERIFICACIÓN DE EXCLUSIVIDAD DE ASIGNACIONES (ZONA 12 - JUNIO 2026) ===\n');
  console.log(`Programaciones en BD para ZONA 12 en Junio 2026: ${progs.length}`);
  ...
  if (estrados === 0) {
    console.log('✅ ¡Cero programaciones extrañas! Solo se programaron los 4 puestos oficiales de ZONA 12 del Excel.');
  } else {
