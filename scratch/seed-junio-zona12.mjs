/**
 * CORAZA CTA — Seed Programación JUNIO 2026 desde Excel (ZONA 12)
 * ===============================================================
 * Lee scratch/excel_parsed_zona12.json y carga la programación real
 * en la base de datos Supabase para ZONA 12.
 */
...
async function main() {
  ...
  console.log(`\n${'═'.repeat(62)}`);
  console.log(`🚀 SEED ZONA 12 COMPLETADO`);
