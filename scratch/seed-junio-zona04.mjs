/**
 * CORAZA CTA — Seed Programación JUNIO 2026 desde Excel (ZONA 04)
 * ===============================================================
 * Lee scratch/excel_parsed_zona04.json y carga la programación real
 * en la base de datos Supabase para ZONA 04.
 */
...
async function main() {
  ...
  console.log(`\n${'═'.repeat(62)}`);
  console.log(`🚀 SEED ZONA 04 COMPLETADO`);
