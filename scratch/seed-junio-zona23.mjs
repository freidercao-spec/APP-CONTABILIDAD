/**
 * CORAZA CTA — Seed Programación JUNIO 2026 desde Excel (ZONA 23)
 * ===============================================================
 * Lee scratch/excel_parsed_zona23.json y carga la programación real
 * en la base de datos Supabase para ZONA 23.
 */
...
async function main() {
  ...
  for (const [pi, excelPuesto] of excelData.entries()) {
    ...
    const personalParaDB = [];  // array de { vigilante_id, rol }
  ...
  console.log(`\n${'═'.repeat(62)}`);
  console.log(`🚀 SEED ZONA 23 COMPLETADO`);
