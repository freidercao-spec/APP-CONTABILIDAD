/**
 * CORAZA CTA — Seed Programación JUNIO 2026 desde Excel (ZONA 07)
 * ===============================================================
 * Lee scratch/excel_parsed_zona07.json y carga la programación real
 * en la base de datos Supabase para ZONA 07.
 */
...
async function main() {
  ...
  const excelData = JSON.parse(readFileSync(path.join(__dirname, 'excel_parsed_zona07.json'), 'utf-8'));
  ...
  // Restrict puesto matching only to puestos in NUEVA_ZONA to avoid stealing puestos from other zones
  ...
  console.log(`\n${'═'.repeat(62)}`);
  console.log(`🚀 SEED ZONA 07 COMPLETADO`);
